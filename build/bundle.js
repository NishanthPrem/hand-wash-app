var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="7.jpg" alt="How To Wash your hands" class="svelte-wwxt9"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(span, "class", "sr-only svelte-1g2on9c");
    			attr(div0, "class", "progress-bar svelte-1g2on9c");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-1g2on9c");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			h1 = element("h1");
    			h1.textContent = "How To Handwash";
    			t1 = space();
    			...
    			h3.innerHTML = `<a href="https://www.who.int/">Picture Source</a>  <br/><br/> 
    <a href="https://www.who.int/">Sound Source</a>`;

    			t8 = space();
    			audio_1 = element("audio");
    			audio_1.innerHTML = `<source src="Rome.mp3" type="audio/mpeg"/>`;
    			attr(h1, "class", "svelte-1b0vhbr");
    			attr(h3, "class", "svelte-1b0vhbr");
    		},
    		m(target, anchor) {
